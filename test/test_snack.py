...
class TestSnackPitch(TestCase):
    ...
    def test_pitch_against_voicesauce_data(self):
        ...
        for fn in wav_fns:
            ...
            F0_os, V_os = snack_pitch(fn, default_snack_method, data_len, frame_length=f_len, window_length=w_len, max_pitch=500, min_pitch=40)
    ...
    def test_pitch_raw(self):
        ...
        for fn in wav_fns:
            F0_raw, V_raw = snack_raw_pitch(fn, default_snack_method, frame_length=0.001, window_length=0.025, max_pitch=500, min_pitch=40)
...
class TestSnackFormants(TestCase):
    ...
    def test_formants_against_voicesauce_data(self):
        ...
        for fn in wav_fns:
            ...
            formants_os = snack_formants(fn, default_snack_method, data_len, frame_length=f_len, window_length=w_len, pre_emphasis=0.96, lpc_order=12)
    ...
    def test_formants_raw(self):
        ...
        # Data was generated by snack 2.2.10 on Manjaro Linux.
        for fn in wav_fns:
            estimates_raw = snack_raw_formants(fn, default_snack_method, frame_length=0.001, window_length=0.025, pre_emphasis=0.96, lpc_order=12)
