...
class TestSnackPitch(TestCase):
    ...
    def test_pitch_against_voicesauce_data(self):
        ...
        for fn in wav_fns:
            ...
            F0_os, V_os = snack_pitch(fn, snack_method, data_len, frame_length=f_len, window_length=w_len, max_pitch=500, min_pitch=40, tcl_shell_cmd=tcl_cmd)
    ...
    def test_pitch_raw(self):
        ...
        for fn in wav_fns:
            F0_raw, V_raw = snack_raw_pitch(fn, snack_method, frame_length=0.001, window_length=0.025, max_pitch=500, min_pitch=40, tcl_shell_cmd=tcl_cmd)
...
class TestSnackFormants(TestCase):
    ...
    def test_formants_against_voicesauce_data(self):
        ...
        for fn in wav_fns:
            ...
            formants_os = snack_formants(fn, snack_method, data_len, frame_length=f_len, window_length=w_len, pre_emphasis=0.96, lpc_order=12, tcl_shell_cmd=tcl_cmd)
    ...
    def test_formants_raw(self):
        ...
        # Data was generated by snack 2.2.10 on Manjaro Linux.
        for fn in wav_fns:
            estimates_raw = snack_raw_formants(fn, snack_method, frame_length=0.001, window_length=0.025, pre_emphasis=0.96, lpc_order=12, tcl_shell_cmd=tcl_cmd)
            ...
            for n in sformant_names:
                ...
                self.assertTrue(np.allclose(estimates_raw[n], sample_data[n], rtol=3e-04, atol=1e-08))
